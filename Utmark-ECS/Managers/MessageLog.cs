namespace Utmark_ECS.Managers
{
    ...
    {
        //    // Update the messages list to store tuples of string and Color
...
// Formating for sending Colored Messages
// _eventManager.Publish(new MessageEvent("[color=red]John[/color] picked up a [color=blue]sword[/color]."));